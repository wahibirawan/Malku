...
export function CalculatorSection({
    ...
    return (
        <div className="w-full max-w-5xl mx-auto space-y-6 md:space-y-10" id="calculator">
            ...
            <div className="bg-white/80 backdrop-blur-md rounded-xl shadow-2xl shadow-primary/5 border border-white/50 overflow-hidden relative">
                {/* Decorative Elements */}
